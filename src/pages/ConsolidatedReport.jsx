...
export default function ConsolidatedReport() {
  ...
  // Monthly breakdown
  const monthlyData = data.monthlyResume.map(item => ({
    month: item.month,
    storeProfit: (item.storeRevenue || 0) - ((item.fixedExpenses || 0) + (item.variableExpenses || 0)) / 2,
    transportProfit: (item.transportRevenue || 0) - ((item.fixedExpenses || 0) + (item.variableExpenses || 0)) / 2,
